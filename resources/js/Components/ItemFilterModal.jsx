...
const ItemFilterModal = memo(function ItemFilterModal({
    ...
    return (
        <div className="absolute right-0 top-full mt-1 z-[100] w-[calc(100vw-24px)] max-w-80 bg-white border border-slate-200 rounded-xl shadow-xl p-3.5 sm:p-4 origin-top-right animate-in fade-in zoom-in-95 duration-150 max-h-[calc(100vh-80px)] overflow-y-auto">
                        ...
                        <div className="grid grid-cols-4 gap-1">
                            {[
                                ...
                                <button
                                    ...
                                    className={`min-w-0 px-1 py-1.5 rounded-md border text-[10px] sm:text-[11px] font-semibold transition-all cursor-pointer text-center ${
                                        stockFilter === item.id
                                            ? "bg-teal-600 text-white border-teal-600 shadow-sm"
                                            : "bg-slate-50 text-slate-700 border-slate-200 hover:bg-slate-100"
                                    }`}
