                ...
                <form onSubmit={onSubmit} className="space-y-3.5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border border-slate-300 rounded-md px-2.5 py-1.5 text-xs sm:text-sm focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 bg-white"
                        />
                    </div>
                    ...
                    <div className="flex items-center justify-end gap-2 border-t border-slate-100 pt-3">
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="inline-flex items-center gap-1.5 px-4 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold rounded-md transition-colors cursor-pointer disabled:opacity-50 shadow-xs"
                        >
