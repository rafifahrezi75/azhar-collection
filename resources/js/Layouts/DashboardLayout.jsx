                ...
                <header className="h-14 sm:h-15 bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-4 sm:px-5 flex items-center justify-between sticky top-0 z-30 shadow-soft-sm">
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <button
                            ...
                            className="flex lg:hidden items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-teal-600 text-white font-semibold text-xs shadow-soft-xs hover:bg-teal-700 transition-all duration-200 cursor-pointer"
                        ...
                        {/* Search Bar */}
                        <div className="hidden md:flex items-center gap-2 bg-slate-100/80 border border-slate-200 rounded-lg px-2.5 py-2 w-56 text-slate-400 text-xs shadow-soft-2xs focus-within:ring-2 focus-within:ring-teal-500/20 focus-within:border-teal-500 focus-within:bg-white focus-within:shadow-soft-xs transition-all duration-200">
                    ...
                    <div className="flex items-center gap-2.5 ml-auto">
                        ...
                        <button className="relative w-8 h-8 rounded-lg bg-slate-100 hover:bg-slate-200/70 border border-slate-200 flex items-center justify-center text-slate-600 transition-all duration-200 cursor-pointer shadow-soft-2xs">
