                            ...
                            <div className="flex items-center gap-2.5 min-w-0">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-500">
                                        Perbarui informasi bahan baku, kemasan
                                        multi-satuan, dan stok.
                                    </p>
                                </div>
                            </div>
                            <button
                                ...
                                <div className="p-3 rounded-md bg-slate-50/80 border border-slate-200 space-y-2 shadow-2xs">
                                    <div className="flex items-center justify-between border-b border-slate-200/80 pb-1.5">
                                        ...
                                        <button
                                            ...
                                            title="Tambah"
                                            className="inline-flex items-center justify-center gap-1 px-2.5 h-7 bg-teal-600 hover:bg-teal-700 disabled:opacity-50 text-white rounded-md text-[11px] font-semibold shadow-sm hover:shadow-md transition-all cursor-pointer"
                                        >
