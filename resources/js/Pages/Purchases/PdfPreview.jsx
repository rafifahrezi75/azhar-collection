...
export default function PdfPreview({ purchase }) {
    const iframeRef = useRef(null);
    const pdfUrl = `/dashboard/purchases/${purchase?.id}/pdf`;
    ...
    return (
        <DashboardLayout>
            <Head
                title={`#${purchase.reference_no} - Preview Nota Pembelian - Azhar Collection`}
            />
                    ...
                    <div className="p-4 sm:p-5 border-b border-slate-100 shrink-0 bg-white">
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            ...
                            <div className="flex items-center gap-2.5 min-w-0">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-500 truncate mt-0.5">
                                        ...
                                        &bull; Lembar cetak dokumen faktur dan rincian pengadaan bahan.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-end gap-2 shrink-0">
                                <a
                                    href={pdfUrl}
                                    download={`Nota_Pembelian_${purchase.reference_no}.pdf`}
                    ...
                    <div className="flex-1 w-full bg-slate-100/60 p-2 sm:p-3 overflow-hidden">
                        <div className="w-full h-full rounded-lg border border-slate-200 overflow-hidden bg-white shadow-2xs">
                            <iframe
                                ...
                                title="Pratinjau PDF Nota Pembelian"
                            />
                        </div>
                    </div>
                </div>
